...
public class Main {
	...
	public static void main(String args[])throws Exception{
		...
		String language = "1", type = "1", abNum = "500", stopwordPath = "y", stemmerOrNot = "1";
		String topic = "-1", ReMethod = "1", RePara = "0.7", beta = "0";
		String linkThresh = "0.1", AlphaC = "0.1", LambdaC = "0.8", op = "2", AlphaS = "-1", LambdaS = "-1";
		String[] arg;

		String file = "/Users/zhangyu/Documents/data/data_test/abstract/localtest";
		String outFile = "/Users/zhangyu/Documents/data/data_test/abstract/result/";
		...
		for(File fOrd : files) {
			...
			arg[8] = RePara;
			arg[9] = beta;
			arg[10] = "/Users/zhangyu/Documents/data/data_test/abstract/" + fOrd.getName() + ".topic";
			mead.Summarize(arg);*/
